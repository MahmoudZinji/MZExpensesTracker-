...
extension Category {
    ...
    static let maviesAndDVDs = Category(id: 301, name: "Movies & DVD's", icon: .film, mainCategoryId: 3)
    ...
    static let payCheques = Category(id: 701, name: "Pay Cheque", icon: .dollar_sign, mainCategoryId: 7)
